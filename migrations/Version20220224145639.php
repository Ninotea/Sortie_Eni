 ...
 */
final class Version20220224145639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD pseudo VARCHAR(255) DEFAULT NULL');
    }
